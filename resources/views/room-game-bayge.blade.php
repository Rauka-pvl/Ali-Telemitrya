...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="join-row">
            ...
            <button id="motionBtn" disabled>Включить датчики</button>
        ...
        <div id="motionLog" class="mono" style="margin-top: 8px; color: var(--muted);">Датчики не активированы</div>
        <div class="bar-wrap">
...
window.addEventListener('load', () => {
    ...
    const resetUiAfterDisconnect = () => {
        ...
        motionBtn.textContent = 'Включить датчики';
    ...
    motionBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            motionActive = true;
            motionBtn.disabled = true;
            motionBtn.textContent = 'Датчики активированы';
            window.addEventListener('devicemotion', onDeviceMotion);
        } catch (error) {
            motionLog.textContent = `Ошибка датчиков: ${error?.message ?? error}`;
        }
    });
